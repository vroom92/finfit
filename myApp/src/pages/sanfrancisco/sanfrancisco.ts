...
/**
 * Generated class for the SanfranciscoPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-Sanfrancisco',
  templateUrl: 'Sanfrancisco.html',
})
export class SanfranciscoPage {
  ...
  ionViewDidLoad() {
    ...
    this.audio2.load();
    this.audio2.play();
    console.log('ionViewDidLoad SanfranciscoPage');
    this._HTTP
